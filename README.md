...
* Install Hugo server as per your system requirement from [here](). I did the configuration for [Windows10](https://gohugo.io/getting-started/installing#for-windows-10-users)
* Fork any of the themes, which you like from [here](https://themes.gohugo.io/)
    `git clone https://github.com/sourcethemes/academic-kickstart.git My_Website`
* `cd` into the `My_Website`.
* `git submodule update --init --recursive`
* run `hugo server`
* by default it will run on `http://localhost:1313/`

## To get custom url - use [Netlify](https://www.netlify.com/) for free
